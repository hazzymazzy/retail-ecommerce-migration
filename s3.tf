...
# Allow public website policy to work (turn off the 4 public-block switches)
...
# Static website hosting (uses the S3 website endpoint: http://...)
...
# Upload files from ../website folder
